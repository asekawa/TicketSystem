...
import synchronizedMethods.Customer;
import synchronizedMethods.TicketPoolSync;
import synchronizedMethods.Ticket;
import synchronizedMethods.Vendor;

public class SynchronizationPerfTest {

	public static void main(String[] args) throws InterruptedException {
		int ticketCount = 100; // Number of tickets to produce

		TicketPoolSync pool = new TicketPoolSync(10); // Queue capacity

...
public class TicketProgrammeManager {
    ...
    public static void main(String[] args) {
        ...
        TicketPoolSync ticketPool = new TicketPoolSync(5); // Shared ticket pool
        ...
        while (running) {
            System.out.println("Commands: addVendor, addCustomer, addReader, addWriter, removeVendor, removeConsumer, removeReader, removeWriter, showTickets, exit");
            ...
            switch (command) {
                ...
                case "addWriter":
                    if (writers.size() < MAX_WRITERS) {
                        ...
                        System.out.println("Writer limit reached.");
                    }
                    break;
            ...
            // Auto shutdown if all ticket production is done and pool is empty
